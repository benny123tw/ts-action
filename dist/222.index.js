...
(function (factory) {
    ...
    const format_1 = __webpack_require__(5796);
    const parser_1 = __webpack_require__(8715);
...
(function (factory) {
    ...
    const scanner_1 = __webpack_require__(1246);
...
(function (factory) {
    ...
    const formatter = __webpack_require__(5796);
    const edit = __webpack_require__(3264);
    const scanner = __webpack_require__(1246);
    const parser = __webpack_require__(8715);
    /**
     * Creates a JSON scanner on the given text.
     * If ignoreTrivia is set, whitespaces or comments are ignored.
     */
